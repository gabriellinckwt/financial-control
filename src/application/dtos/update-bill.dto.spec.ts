...
describe('UpdateBillDto', () => {
  it('should create a DTO with provided values', () => {
    const dto = new UpdateBillDto(1, 'Test Bill', 'Utilities', 100, 1);
  ...
  it('should have all required properties', () => {
    const dto = new UpdateBillDto(1, 'Test', 'Category', 100, 1);
  ...
  it('should maintain correct types for properties', () => {
    const dto = new UpdateBillDto(1, 'Test', 'Category', 99.99, 3);
  ...
  it('should allow property updates', () => {
    const dto = new UpdateBillDto(1, 'Initial', 'Category', 100, 1);
