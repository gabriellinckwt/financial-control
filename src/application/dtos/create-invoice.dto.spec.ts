...
describe('CreateInvoiceDto', () => {
  it('should create a DTO with provided values', () => {
    const dto = new CreateInvoiceDto('Test Invoice', 'Utilities', 100, 1);
  ...
  it('should have all required properties', () => {
    const dto = new CreateInvoiceDto('Test', 'Category', 100, 1);
  ...
  it('should maintain correct types for properties', () => {
    const dto = new CreateInvoiceDto('Test', 'Category', 99.99, 3);
  ...
  it('should allow property updates', () => {
    const dto = new CreateInvoiceDto('Initial', 'Category', 100, 1);
